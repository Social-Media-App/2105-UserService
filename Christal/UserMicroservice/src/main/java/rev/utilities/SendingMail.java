...
public class SendingMail {
	...
	public static void sendMail(String receipient, String username,String token) throws MessagingException {
		...
		Message message = prepareMessage(session, myEmail, username, receipient,token);
	...
	private static Message prepareMessage(Session session, String myEmail,String username, String receipient,String token) {
